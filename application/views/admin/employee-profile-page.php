                     ...
                     <div class="d-flex align-items-start mt-3 gap-3">
                        ...
                        <div>
                           <div class="leave_btns">
                                ...
                                <?php else : ?>
                                    <small>Add Employee Leave</small>
                                <?php endif; ?>

                                <?php if(!empty($employee_leaves)):?>
                                <?php else : ?>
                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#addEmployeeLeave<?php echo $empdata->main_employee_id; ?>"><i class="bx bx-plus"></i></a> &nbsp; 
                                <?php endif; ?>
                              <?php if(!empty($employee_leaves)):?>
                                <a href="<?php echo $employee_leaves->leave_url; ?>" target="_blank"><i class="bx bx-show"></i></a> &nbsp; 
                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#deleteEmployeeLeave<?php echo $empdata->main_employee_id; ?>"><i class="bx bx-trash"></i></a> &nbsp; 
                            <?php else : ?>
                            <?php endif; ?>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card mb-4">
            <form action="<?php echo base_url('admin/AM_Controller/addingPersonalityRanks') ?>" method="post">
...
<div class="modal fade" id="softwareExpirticeModel<?php echo $empdata->main_employee_id; ?>" tabindex="-1" aria-hidden="true">
    <form action="<?php echo base_url('admin/AM_Controller/addSoftwareExpertise');?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="deleteSoftware<?php echo $software->software_expertise_id; ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo base_url('admin/AM_Controller/deleteSoftwareExpertise'); ?>" method="POST">
...
<div class="modal fade" id="addEmployeeLeave<?php echo $empdata->main_employee_id; ?>" tabindex="-1" aria-hidden="true">
    <form action="<?php echo base_url('admin/AM_Controller/addEmployeeLeaves');?>" method="POST" enctype="multipart/form-data">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Leave Record</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        <input type="hidden" name="employee_id" value="<?php echo $empdata->main_employee_id; ?>">
                        <div>
                            <div class="mb-3 col-md-12">
                                <label for="address" class="form-label">Insert URl</label>
                                <input type="url" class="form-control" id="" name="leave_url" value="" placeholder="Enter URL" />
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="address" class="form-label">File Name</label>
                                <input type="text" class="form-control" id="" name="file_name" value="" placeholder="Enter Software name" />
                            </div>
                        </div>
                    </div>
                <div class="modal-footer">
...
<div class="modal fade" id="deleteEmployeeLeave<?php echo $empdata->main_employee_id; ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Delete Leave Record</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to delete leave file?</p>
            </div>
            <div class="modal-footer">
                <form action="<?php echo base_url('admin/AM_Controller/deleteEmployeeLeaveRecord'); ?>" method="POST">
                    <input type="hidden" name="employee_id" value="<?php echo $empdata->main_employee_id; ?>">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-danger">Delete</button>
                </form>
...
<div class="modal fade" id="personalityDetails" tabindex="-1" aria-hidden="true">
    <form action="<?php echo base_url('admin/AM_Controller/addPersonalityDetails');?>" method="POST" enctype="multipart/form-data">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="editPersonalityDetails" tabindex="-1" aria-hidden="true">
    <form action="<?php echo base_url('admin/AM_Controller/editPersonalityDetails');?>" method="POST" enctype="multipart/form-data">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Personality Information</h5>
...
<div class="modal fade" id="deletePersonalityDetails" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo base_url('admin/AM_Controller/deletePersonalityDetails'); ?>" method="POST">
