<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold">
            <a href="<?php echo base_url("admin/view-employee-performance-list"); ?>"><i class="bx bx-left-arrow-alt"></i> BACK</a>
        </h4>
            ...
            <div class="col-xl">
                ...
                <div class="">
                        <div class="card-body bg-primary-b btn-justi-ed">
                            <?php if($emp_evaluation_period->evaluation_status == 2 ): ?>
                            ...
                            <?php if($emp_evaluation_period->evaluation_status == 2): ?>
                                <a href="<?php echo base_url('admin/AM_Controller/adminEditYourEvaluation/'.$emp_evaluation_period->employee_evaluation_id); ?>" class="btn btn-primary">Edit Performance</a>
                            <?php else:?>
                                <button class="btn btn-primary" disabled>Edit Performance</button>
                            <?php endif; ?>

                            <a href="<?php echo base_url('admin/AM_Controller/viewEmployeeEvaluationHistory/'.$emp_evaluation_period->employee_evaluation_id) ?>" class="btn btn-primary">
                                Performance History
                            </a>
                ...
                <div class="nav-align-top mb-4">
                    <ul class="nav nav-pills mb-3" role="tablist">
                      ...
                      <li class="nav-item" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span><?php echo ($emp_evaluation_period->evaluation_status > 1) ? 'Employee has been locked' : 'Employee has not locked his evaluation yet.'; ?></span>">
                        <button type="button"
                        class="nav-link"
                        role="tab"
                        data-bs-toggle="tab"
                        ...
                        <?php echo ($emp_evaluation_period->evaluation_status > 1) ? '' : 'disabled'; ?>>

                        Current Metrics <?php echo ($emp_evaluation_period->evaluation_status > 1) ? '' : ''; ?>
                        </button>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-evaluation-metrics" aria-controls="navs-pills-evaluation-metrics" aria-selected="false">
                            Metric Description
                        </button>
                      </li>
                    </ul>
                    <div class="tab-content">
                    <div class="tab-pane fade" id="navs-pills-evaluation-metrics" role="tabpanel">
                        <div class="metric-description-table">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>N/A for this Semester</td>
                                        <td><em>No exposure to this task in the recent 6 months.</em></td>
                                    </tr>
                                    <tr>
                                        <td>Needs Improvement</td>
                                        <td>Requires improvement with many risk areas that impact the execution of this task.</td>
                                    </tr>
                                    <tr>
                                        <td>Work in Progress</td>
                                        <td>Work in progress with some risk areas that may impact the execution of this task.</td>
                                    </tr>
                                    <tr>
                                        <td>Acceptable</td>
                                        <td>Adequate performance with a fair track record of success for this task.</td>
                                    </tr>
                                    <tr>
                                        <td>Good</td>
                                        <td>Strong performance with a good track record of success for this task.</td>
                                    </tr>
                                    <tr>
                                        <td>Outstanding</td>
                                        <td>Flawless track record and execution for this task. Employee is able to educate teammates as an exemplary model for this task.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                    ...
                                    <div class="nav-align-top mb-4">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="navs-justified-section-<?php echo $section->section_id; ?>" role="tabpanel">
                                                <?php echo $section->section_instruction; ?>
                                                <hr>
                                                <table class="table">
...
<div class="modal fade" id="empEvaluationSubmit" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <hr>
            ...
            <form action="<?php echo base_url('admin/AM_Controller/adminLockEmployeeEvaluation'); ?>" method="POST">
