            ...
            <div class="col-xl">
                ...
                <div class="">
                        <div class="card-body bg-primary-b btn-justi-ed">
                            ...
                            <?php if($emp_evaluation_period->evaluation_status == 2): ?>
                                <a href="<?php echo base_url('supervisor/SV_Controller/supervisorAssignEditYourEvaluation/'.$emp_evaluation_period->employee_evaluation_id); ?>" class="btn btn-primary">Edit Performance</a>
                            <?php else:?>
                                <button class="btn btn-primary" disabled>Edit Performance</button>
                            <?php endif; ?>

                            <a href="<?php echo base_url('supervisor/SV_Controller/employeePerformanceHistory/'.$emp_evaluation_period->employee_evaluation_id); ?>" class="btn btn-primary">
                                Performance History
                            </a>
...
<div class="modal fade" id="empEvaluationSubmit" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <hr>
            ...
            <form action="<?php echo base_url('supervisor/SV_Controller/LockAssignEmployeeEvaluation'); ?>" method="POST">
