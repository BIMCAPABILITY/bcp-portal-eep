...
=======
                                                        ...
                                                        $countloop = array(
                                                            "quality_emp_avg" => $re_evaluate->quality_emp_avg,
                                                            "knowledge_performance_emp_avg" => $re_evaluate->knowledge_performance_emp_avg,
                                                            "communication_emp_avg" => $re_evaluate->communication_emp_avg,
                                                            "time_management_emp_avg" => $re_evaluate->time_management_emp_avg,
                                                            "team_management_emp_avg" => $re_evaluate->team_management_emp_avg,
                                                            "reliability_emp_avg" => $re_evaluate->reliability_emp_avg,
                                                            "productivity_emp_avg" => $re_evaluate->productivity_emp_avg
                                                        );
                                                        ...
                                                        if($store_AVG){
                                                            $sumTotal = $re_evaluate->communication_emp_avg + $re_evaluate->knowledge_performance_emp_avg + $re_evaluate->quality_emp_avg + $re_evaluate->team_management_emp_avg + $re_evaluate->reliability_emp_avg + $re_evaluate->time_management_emp_avg + $re_evaluate->productivity_emp_avg; 
...
<<<<<<< HEAD
                                                ...
                                                $period  = 'Yearly';
=======
                                                if(($re_evaluate->evaluate_date_category)==90){
...
=======
                            <span class="btn-re-justi">
                                <?php if(($re_evaluate->submit_manager_status)==2): ?>
                                    <button class="btn btn-md btn-primary" type="button" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="<span>Disabled</span>" disabled> Performance Re-Evaluate</button>
                                <?php else: ?>
                                    <a class="btn btn-md btn-primary" data-bs-toggle="modal" data-bs-target="#empScoreEdit" href="javascript:void(0);"> Performance Re-Evaluate</a>
>>>>>>> 8ce454d (new update employee portal v1.1.0)
                                <?php endif; ?>
                            </span>
                            <span class="btn-re-justi">
...
=======
                                                    ...
                                                    <tr class="remove_bb">
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($re_evaluate->m_knowledge_performance_question_6 === $re_evaluate->knowledge_performance_question_6){
                                                                    $same_knowledge_performance_question_6 = $re_evaluate->m_knowledge_performance_question_6;
                                                                }else{
                                                                    $same_knowledge_performance_question_6 = false;
                                                                }

                                                                if($re_evaluate->knowledge_performance_question_6==0){
                                                                ...
                                                                }elseif($re_evaluate->m_knowledge_performance_question_6==$x){
                                                                ...
                                                                }elseif($re_evaluate->knowledge_performance_question_6==$x){
                                                            ...
                                                            ?>
                                                            <input type="hidden" name="m_knowledge_performance_question_6" value="<?php echo $re_evaluate->m_knowledge_performance_question_6; ?>">
                                                            <input type="hidden" name="e_knowledge_performance_question_6" value="<?php echo $re_evaluate->knowledge_performance_question_6; ?>">
                                                        </td>
                                                    </tr>
                                                    <tr class="remove_bb">
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($re_evaluate->m_knowledge_performance_question_7 === $re_evaluate->knowledge_performance_question_7){
                                                                    $same_knowledge_performance_question_7 = $re_evaluate->m_knowledge_performance_question_7;
                                                                }else{
                                                                    $same_knowledge_performance_question_7 = false;
                                                                }

                                                                if($re_evaluate->knowledge_performance_question_7==0){
                                                                ...
                                                                }elseif($re_evaluate->m_knowledge_performance_question_7==$x){
                                                                ...
                                                                }elseif($re_evaluate->knowledge_performance_question_7==$x){
                                                            ...
                                                            ?>
                                                            <input type="hidden" name="m_knowledge_performance_question_7" value="<?php echo $re_evaluate->m_knowledge_performance_question_7; ?>">
                                                            <input type="hidden" name="e_knowledge_performance_question_7" value="<?php echo $re_evaluate->knowledge_performance_question_7; ?>">
>>>>>>> 8ce454d (new update employee portal v1.1.0)
                                                        </td>
                                                    </tr>
                                                    <tr class="remove_bb">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    ...
                                                    <tr class="remove_bb">
                                                        ...
                                                        <td>
                                                            <?php
                                                            if($re_evaluate->m_communication_question_6 === $re_evaluate->communication_question_6){
                                                                $same_communication_question_6 = $re_evaluate->m_communication_question_6;
                                                            }else{
                                                                $same_communication_question_6 = false;
                                                            }

                                                            if($re_evaluate->communication_question_6==0){
                                                            ...
                                                            }elseif($re_evaluate->m_communication_question_6==$x){
                                                            ...
                                                            }elseif($re_evaluate->communication_question_6==$x){
                                                        ...
                                                        <input type="hidden" name="m_communication_question_6" value="<?php echo $re_evaluate->m_communication_question_6; ?>">
                                                        <input type="hidden" name="e_communication_question_6" value="<?php echo $re_evaluate->communication_question_6; ?>">
                                                    </tr>
...
=======
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($re_evaluate->m_time_management_question_6 === $re_evaluate->time_management_question_6){
                                                                    $same_time_management_question_6 = $re_evaluate->m_time_management_question_6;
                                                                }else{
                                                                    $same_time_management_question_6 = false;
                                                                }

                                                                if($re_evaluate->time_management_question_6==0){
                                                                ...
                                                                }elseif($re_evaluate->m_time_management_question_6==$x){
                                                                ...
                                                                }elseif($re_evaluate->time_management_question_6==$x){
                                                            ...
                                                            ?>
                                                            <input type="hidden" name="m_time_management_question_6" value="<?php echo $re_evaluate->m_time_management_question_6; ?>">
                                                            <input type="hidden" name="e_time_management_question_6" value="<?php echo $re_evaluate->time_management_question_6; ?>">
                                                        </td>
                                                    </tr>
                                                    <tr class="remove_bb">
                                                        <td>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    ...
                                                    <tr class="remove_bb">
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($re_evaluate->m_team_management_question_1 === $re_evaluate->team_management_question_1){
                                                                    $same_team_management_question_1 = $re_evaluate->m_team_management_question_1;
                                                                }else{
                                                                    $same_team_management_question_1 = false;
                                                                }

                                                                if($re_evaluate->team_management_question_1==0){
                                                                ...
                                                                }elseif($re_evaluate->m_team_management_question_1==$x){
                                                                ...
                                                                }elseif($re_evaluate->team_management_question_1==$x){
                                                    ...
                                                    <tr class="remove_bb">
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($re_evaluate->m_team_management_question_2 === $re_evaluate->team_management_question_2){
                                                                    $same_team_management_question_2 = $re_evaluate->m_team_management_question_2;
                                                                }else{
                                                                    $same_team_management_question_2 = false;
                                                                }

                                                                if($re_evaluate->team_management_question_2==0){
                                                                ...
                                                                }elseif($re_evaluate->m_team_management_question_2==$x){
                                                                ...
                                                                }elseif($re_evaluate->team_management_question_2==$x){
                                                    ...
                                                    <tr class="remove_bb">
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($re_evaluate->m_team_management_question_3 === $re_evaluate->team_management_question_3){
                                                                    $same_team_management_question_3 = $re_evaluate->m_team_management_question_3;
                                                                }else{
                                                                    $same_team_management_question_3 = false;
                                                                }

                                                                if($re_evaluate->team_management_question_3==0){
                                                                ...
                                                                }elseif($re_evaluate->m_team_management_question_3==$x){
                                                                ...
                                                                }elseif($re_evaluate->team_management_question_3==$x){
                                                    ...
                                                    <tr class="remove_bb">
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($re_evaluate->m_team_management_question_4 === $re_evaluate->team_management_question_4){
                                                                    $same_team_management_question_4 = $re_evaluate->m_team_management_question_4;
                                                                }else{
                                                                    $same_team_management_question_4 = false;
                                                                }

                                                                if($re_evaluate->team_management_question_4==0){
                                                                ...
                                                                }elseif($re_evaluate->m_team_management_question_4==$x){
                                                                ...
                                                                }elseif($re_evaluate->team_management_question_4==$x){
                                                    ...
                                                    <tr class="remove_bb">
                                                        ...
                                                        <td>
                                                            <?php
                                                                ...
                                                                if($re_evaluate->m_team_management_question_5 === $re_evaluate->team_management_question_5){
                                                                    $same_team_management_question_5 = $re_evaluate->m_team_management_question_5;
                                                                }else{
                                                                    $same_team_management_question_5 = false;
                                                                }

                                                                if($re_evaluate->team_management_question_5==0){
                                                                ...
                                                                }elseif($re_evaluate->m_team_management_question_5==$x){
                                                                ...
                                                                }elseif($re_evaluate->team_management_question_5==$x){
                                                    ...
                                                    <div class="re-update-score-box">
                                                        <span class="indi-re-avg-emp">
                                                            ...
                                                            <?php  $comm_avg= $re_evaluate->team_management_emp_avg; ?>
                                                            <?php if($comm_avg <= 1): ?>
                                                            <button type="button" class="btn-p-avg btn btn-outline-danger">Not sufficient <?php echo $comm_avg; ?> <i class='bx bx-tachometer' ></i></button>
                                                            <?php elseif($comm_avg > 1 && $comm_avg <= 2): ?>
                                                            <button type="button" class="btn-p-avg btn btn-outline-danger">Not sufficient <?php echo $comm_avg; ?> <i class='bx bx-tachometer' ></i></button>
                                                        ...
                                                        <div class="re-update-score-box">
                                                            ...
                                                            <?php  $comm_avg= $re_evaluate->m_team_management_emp_avg; ?>
                                                            <?php if($comm_avg <= 1): ?>
                                                            <button type="button" class="btn-p-avg btn btn-outline-danger">Not sufficient <?php echo $comm_avg; ?> <i class='bx bx-tachometer' ></i></button>
                                                            <?php elseif($comm_avg > 1 && $comm_avg <= 2): ?>
                                                            <button type="button" class="btn-p-avg btn btn-outline-danger">Not sufficient <?php echo $comm_avg; ?> <i class='bx bx-tachometer' ></i></button>
                                                        ...
                                                        <input type="hidden" name="m_team_management_emp_avg_old" value="<?php echo $re_evaluate->m_team_management_emp_avg; ?>">
                                                    </td>
                                                    ...
                                                    <tr class="remove_bb">
                                                        <td colspan="2">
                                                            ...
                                                            <textarea class="form-control" name="team_management_comments" id="" cols="3" rows="3" disabled><?php echo $re_evaluate->team_management_comments; ?></textarea>
                                                            <input type="hidden" name="team_management_comments_old" value="<?php echo $re_evaluate->team_management_comments; ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            ...
                                                            <textarea class="form-control" name="m_team_management_comments" cols="3" rows="3" disabled><?php echo $re_evaluate->m_team_management_comments; ?></textarea>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
=======
                  ['Team Management', <?php echo $re_evaluate->team_management_emp_avg; ?>, '<?php echo $re_evaluate->team_management_emp_avg; ?>', <?php echo $re_evaluate->m_team_management_emp_avg; ?>, '<?php echo $re_evaluate->m_team_management_emp_avg; ?>'],
                  ['Reliability & Professionalism', <?php echo $re_evaluate->reliability_emp_avg; ?>, '<?php echo $re_evaluate->reliability_emp_avg; ?>', <?php echo $re_evaluate->m_reliability_emp_avg; ?>, '<?php echo $re_evaluate->m_reliability_emp_avg; ?>'],
                  ['Task & Time Management', <?php echo $re_evaluate->time_management_emp_avg; ?>, '<?php echo $re_evaluate->time_management_emp_avg; ?>', <?php echo $re_evaluate->m_time_management_emp_avg; ?>, '<?php echo $re_evaluate->m_time_management_emp_avg; ?>'],
                  ['Adaptability & Proactivity', <?php echo $re_evaluate->productivity_emp_avg; ?>, '<?php echo $re_evaluate->productivity_emp_avg; ?>', <?php echo $re_evaluate->m_productivity_emp_avg; ?>, '<?php echo $re_evaluate->m_productivity_emp_avg; ?>'],
>>>>>>> 8ce454d (new update employee portal v1.1.0)
