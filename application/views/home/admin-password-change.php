        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              <form id="formAuthentication" method="POST" class="mb-3" action="<?php echo base_url('Login/updateAdminPass'); ?>" data-parsley-validate data-toggle="validator" enctype="multipart/form-data">
