...
class SV_Controller extends CI_Controller {
    ...
    function index() {
        ...
        $data['total_assign_employee'] = $this->sm->getTotalAssignEmployee($id);
        $data['total_evaluation'] = $this->sm->getTotalEvaluation($id);
        $data['total_evaluation_complete'] = $this->sm->getTotalEvaluationComplete($id);
    ...
    public function viewAssignEmployeeProfileDetails($id){
        ...
        $data['software_expertise'] = $this->sm->getSoftwareExpertise($id);
        $history_data['employee_history'] = $this->sm->getEmployeeHistory($id);
    ...
    public function employeePerformanceHistory($evaluation_id){
        ...
        $columns = [
            ...
            ['data' => 4, 'title' => 'lEVEL', 'filterType' => 'text'],
            ['data' => 5, 'title' => 'Spectrum', 'filterType' => 'text'],
            ['data' => 6, 'title' => 'Evaluation Status', 'filterType' => 'text'],
            ['data' => 7, 'title' => 'Action', 'filterType' => 'text'],
        ];
        $data['columns'] = $columns;
