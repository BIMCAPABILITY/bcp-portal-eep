...
class EM_Controller extends CI_Controller {
    ...
    public function employeeProfile(){
        ...
        $data['software_expertise'] = $this->em->getSoftwareExpertise($id);
        $history_data['employee_history'] = $this->em->getEmployeeHistory($id);
        $data['employee_leaves'] = $this->em->getEmployeeLeaves($id);

        $data['employee_salary'] = $this->em->getEmployeeSalary($id);
        $data['employee_personality'] = $this->em->getEmployeePersonality($id);
        $data['personality_rank'] = $this->em->getEmployeePersonalityRank($id);
    ...
    public function addSoftwareExpertise(){
        ...
        $res = $this->em->addSoftwareExpertiseDB($data);
        if($res){
    ...
    public function deleteSoftwareExpertise($id){
        ...
        $employee_id = $this->input->post('employee_id');
        $res = $this->em->deleteSoftwareExpertiseDB($software_expertise_id);
        if($res){
    ...
    public function addPersonalityDetails(){
        ...
        $res = $this->em->addPersonalityDetailsDB($data);
        if($res){
    ...
    public function editPersonalityDetails(){
        ...
        $res = $this->em->editPersonalityDetailsDB($employee_id, $data);
        if($res){
    ...
    public function deletePersonalityDetails($id){
        ...
        $employee_id = $this->input->post('employee_id');
        $res = $this->em->deletePersonalityDetailsDB($personality_id, $employee_id);
        if($res){
    ...
    public function addingPersonalityRanks(){
        ...
        if($submit_condi == 1){
            ...
            $res = $this->em->addingPersonalityRanksDB($data);
            if($res){
            ...
            $res = $this->em->editPersonalityRanksDB($employee_id, $data);
            if($res){
