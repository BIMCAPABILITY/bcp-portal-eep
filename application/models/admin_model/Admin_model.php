...
public function deleteEmployeeLeaveRecordDB($id){
    $this->db->where('employee_id', $id);
    return $this->db->delete('employee_leaves');
}
...
public function fetchAllAssignemployeeData($id){
    ...
    public function removeAssignAccess($id){
        $this->db->where('assign_id', $id);
        return $this->db->delete('pe_assign_employee');
    }
    ...
    public function getTotalSubmittedEvaluation(){
        $q = $this->db->select('*')
        ->from('pe_evaluation_table')
        ->where('evaluation_status', 3)
        ->get();
        return $q->num_rows();
    }

    public function getTotalPedingEvaluation(){
        $q = $this->db->select('*')
        ->from('pe_evaluation_table')
    ...
    public function getTotalAssignEmployee(){
        $q = $this->db->select('*')
        ->from('pe_assign_employee')
    ...
    public function addEmployeeLeavesDB($data){
        return $this->db->insert('employee_leaves', $data);
    }
