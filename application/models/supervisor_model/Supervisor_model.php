...
class Supervisor_model extends CI_Model {
    ...
    public function getTotalAssignEmployee($id){
        $q = $this->db->select('*')
        ->from('pe_assign_employee')
        ->where('assign_supervisor_id', $id)
        ->get();
        return $q->num_rows();
    }

    public function getTotalEvaluation($id){
        $q = $this->db->select('*')
        ->from('pe_evaluation_table')
    ...
    public function getTotalEvaluationComplete($id){
        $q = $this->db->select('*')
        ->from('pe_evaluation_table')
        ->where('employee_id', $id)
