...
$route['change-password'] = 'auth/Users/changePassword';
$route['forgot-password'] = 'auth/Login/forgotUserPassword';
$route['update-forgot-password'] = 'auth/Login/updateForgotPassword';
